      ...
      <div className="m-4">
        ...
        <div className="mt-4">
          <Select label="Select Region">
            ...
            <Option>Bono Ahafo</Option>
            <Option>Bono East</Option>
            <Option>Central</Option>
            <Option>Eastern</Option>
            <Option>Greater Accra</Option>
            <Option>Northern East</Option>
        ...
        <div className="mt-4">
          <Select label="Select District">
            ...
            <Option>Wa</Option>
            <Option>Secondi Takoradi</Option>
            <Option>Sefwi Wiaso</Option>
            <Option>Ho</Option>
          </Select>
        </div>
